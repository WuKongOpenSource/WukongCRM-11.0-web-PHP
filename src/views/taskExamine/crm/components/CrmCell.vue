      ...
      <div class="examine-cell__bd">
        ...
        <flexbox class="examine-content">
          ...
          <div class="examine-content__bd">
            <div>
              <a @click="handleClick('detail')">{{ data.name }}</a>
            </div>
            <div
        ...
        <div class="examine-stage">
          <i :class="getStatusIcon(data.check_status)" :style="{ color: getTaskStatusColor(data.check_status) }" /><span>{{ `${data.examineName || ''}${getTaskStatusName(data.check_status)}` }}</span>
        </div>
