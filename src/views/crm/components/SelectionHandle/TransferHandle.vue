...
export default {
  ...
  methods: {
    ...
    getParams() {
      var ownerUserId = this.usersList[0].id
      var params = {
        // owner_user_id: ownerUserId,
        // leads_id: this.selectionList[0].leads_id,
        is_remove: this.removeType
        // type: 1
      }

      // if (this.showRemoveType) {
      //   params.types = this.removeType
      // }
      ...
      params[this.crmType + '_id'] = this.selectionList.map(item => item[this.crmType + '_id'])
