...
export default {
  ...
  computed: {
    ...
    mainFileList() {
      if (this.detailData && this.detailData.cover_images) {
        return this.detailData.cover_images
      }
    ...
    detailFileList() {
      if (this.detailData && this.detailData.details_images) {
        return this.detailData.details_images
      }
