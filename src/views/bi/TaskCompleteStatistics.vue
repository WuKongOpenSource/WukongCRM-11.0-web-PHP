...
export default {
  ...
  computed: {
    postParams() {
      ...
      params.type = this.dataSelect == 1 ? 1 : 2// isUser  0 部门 1 员工
      if (this.dataSelect == 1) {
        params.structure_id = this.deptSelectValue.length > 0 ? this.deptSelectValue[0].id : ''
      } else {
  ...
  methods: {
     ...
     */
    exportClick() {
      this.requestExportInfo(biAchievementStatisticsExportAPI, this.postParams, 'statistics')
    }
  }
}
</script>
