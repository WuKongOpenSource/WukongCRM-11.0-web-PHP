  ...
  <div
    ...
    <div class="content">
      <div class="content-title">
        回款金额：<span class="special">{{ data.receivables_count || 0 }}</span>元；开票金额：<span class="special">{{ data.invoice_count || 0 }}</span>元</div>
...
export default {
  ...
  data() {
    return {
      ...
      fieldList: [
        ...
        { field: 'invoice_money', name: '开票金额' },
        { field: 'not_invoice', name: '已回款未开票' },
        { field: 'not_receivables', name: '已开票未回款' }
      ]
    }
  },
  computed: {},
  ...
  methods: {
     ...
     */
    exportClick() {
      this.requestExportInfo(biAchievementInvoiceExportAPI, this.postParams, 'invoice')
    }
  }
}
</script>
